  ...
  return {
    ...
    Z3: {
      ...
      mk_tuple_sort: function (c, mk_tuple_name, field_names, field_sorts) {
        ...
        try {
          let ret = Mod.ccall(
            ...
            [c, mk_tuple_name, field_names.length, intArrayToByteArr(field_names), intArrayToByteArr(field_sorts), outAddress, outArray_proj_decl],
          );
          return {
            rv: ret,
      ...
      mk_lambda_const: function (c, bound, body) {
        return Mod.ccall("Z3_mk_lambda_const", "number", ["number", "number", "array", "number"], [c, bound.length, intArrayToByteArr(bound), body]);
      },
